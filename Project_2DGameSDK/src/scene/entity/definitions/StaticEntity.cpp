...
namespace game {
  StaticEntity::StaticEntity(int type, Game* game, std::vector<StaticShape*> shapes, bool isCollidable) : Entity(type, game), mIsCollidable(isCollidable), mShapes(shapes) {

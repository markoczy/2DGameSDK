...
namespace game {
  ...
  SpriteDynamicEntity::SpriteDynamicEntity(int type, GameBase* game, sf::Texture* texture, std::vector<Shape<DynamicShapeDefinition>*> shapes, bool isCollidable) : DynamicEntity(type, game, nullptr, shapes, isCollidable) {

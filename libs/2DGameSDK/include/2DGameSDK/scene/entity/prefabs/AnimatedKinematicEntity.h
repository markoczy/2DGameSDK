/**
 * @file AnimatedKinematicEntity.h
 * @author Aleistar Markoczy (a.markoczy@gmail.com)
 * @brief AnimatedKinematicEntity class
 * @version 1.0
 * @date 2020-01-15
 * 
...
namespace game {
  ...
  /**
   * @brief Kinematic entity with animated render strategy
   * 
   */
  class GAMESDK_DLL AnimatedKinematicEntity : public KinematicEntity {
  public:
    /**
     * @brief Constructs a new Animated Kinematic Entity
     * 
